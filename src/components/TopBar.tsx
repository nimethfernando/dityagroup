...
export default function TopBar() {
  return (
    <div className="bg-[#001025] border-b border-white/5 text-xs text-gray-300 hidden md:block select-none">
      <div className="max-w-[1140px] mx-auto px-4 py-2 flex flex-wrap justify-between items-center gap-4">
        ...
        <div className="flex items-center space-x-6">
          <a
            ...
            className="flex items-center space-x-2 text-gray-300 hover:text-[#FF5722] transition-colors font-medium group"
          >
            <span className="w-5 h-5 rounded-full bg-white/5 flex items-center justify-center group-hover:bg-[#FF5722]/20 transition-colors">
        ...
        <div className="flex items-center space-x-2.5">
          <a
            ...
            className="w-7 h-7 rounded-full bg-white/5 hover:bg-[#FF5722] text-gray-300 hover:text-white flex items-center justify-center transition-all duration-200"
            aria-label="YouTube"
          >
