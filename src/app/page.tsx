        ...
        <div className="relative z-10 max-w-[1140px] mx-auto px-4 w-full pt-16 lg:pt-24 pb-12 flex-1 flex items-center">
          <div className="max-w-xl space-y-6">
            ...
            <p className="text-sm sm:text-base text-gray-700 leading-relaxed max-w-lg font-medium">
              We blend timeless sciences with modern innovations to help you gain clarity, create
              wealth, build connections and live a life of purpose and fulfillment.
            </p>
              ...
              <div className="absolute -bottom-6 left-4 right-4 sm:left-6 sm:right-6 bg-[#011633] text-white p-6 sm:p-7 rounded-asymmetric shadow-2xl border border-white/10">
                ...
                <ul className="space-y-2 text-xs sm:text-sm text-gray-200">
                  <li className="flex items-center space-x-2.5">
                    ...
                    <span>Simplicity Creates Growth</span>
                  </li>
                  <li className="flex items-center space-x-2.5">
                    <span className="w-5 h-5 rounded-full bg-[#FF5722] flex items-center justify-center shrink-0">
                      <Check className="w-3.5 h-3.5 text-white" />
                    </span>
                    <span>Growth Through Better Systems</span>
                  </li>
                  <li className="flex items-center space-x-2.5">
                    <span className="w-5 h-5 rounded-full bg-[#FF5722] flex items-center justify-center shrink-0">
                      <Check className="w-3.5 h-3.5 text-white" />
            ...
            <div className="lg:col-span-7 space-y-6 pt-8 lg:pt-0">
              <div className="space-y-2">
                <span className="text-xs font-bold text-[#FF5722] tracking-wider uppercase flex items-center space-x-2">
                  ...
                  <span>Welcome to DITYA GROUP</span>
                </span>
                <h2 className="text-2xl sm:text-3xl lg:text-[38px] font-extrabold text-[#011633] leading-tight">
                  Our Vision Is Creating Infinite Growth Possibilities
                </h2>
              </div>

              <p className="text-sm sm:text-[15px] text-gray-600 leading-relaxed">
                If you’re like most ambitious individuals or business owners, you manage multiple
                roles at once—handling finances, operations, strategy, and execution. Managing
                everything alone can become overwhelming and limit your true growth potential. That’s
                where Ditya Group steps in.
              </p>

              <p className="text-sm sm:text-[15px] text-gray-600 leading-relaxed">
                We provide integrated solutions across stock market guidance with live trading
                support, business growth, numerology & spiritual guidance, online doctor appointment
                services, math learning solutions, and coworking spaces—all designed to simplify your
                life and accelerate your success. Our approach combines practical expertise with deep
                insight to help you make powerful and aligned decisions.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 pt-2">
                ...
                <div className="p-5 border border-gray-200 rounded-asymmetric bg-white shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <h4 className="text-base font-bold text-[#011633] mb-1.5">Increase Growth</h4>
                  <p className="text-xs sm:text-sm text-gray-500 leading-relaxed">
                    Partnering with Ditya Group leads to smarter decisions, higher productivity, and
                ...
                <div className="p-5 border border-gray-200 rounded-asymmetric bg-white shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <h4 className="text-base font-bold text-[#011633] mb-1.5">Save Time</h4>
                  <p className="text-xs sm:text-sm text-gray-500 leading-relaxed">
                    With Ditya Group, you can streamline tasks and focus on growth while we handle the
                    support systems
                  </p>
                </div>
              </div>
              ...
              <div className="pt-3 border-t border-gray-100 flex items-center justify-between">
                <div>
                  <h5 className="text-base font-bold text-[#011633]">Aamitt Batra</h5>
                  <p className="text-xs text-gray-500 font-medium">CEO & Founder Ditya Group</p>
                </div>
        ...
        <div className="max-w-[1140px] mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-6 relative">
              ...
              <div className="absolute -bottom-6 left-4 right-4 sm:left-6 sm:right-6 bg-white p-6 sm:p-7 rounded-asymmetric shadow-2xl border-l-4 border-[#FF5722] border-t border-r border-b border-gray-100">
                <p className="text-xs sm:text-sm text-gray-600 leading-relaxed italic">
                  “Working with Ditya Group has been a game changer. Their guidance in trading,
                  numerology, and business support made decision-making easier and more effective.
                  Everything is well-managed and results are clearly visible. Truly worth the
                  investment and their other services.”
                </p>
                <h5 className="text-sm font-bold text-[#011633] mt-3">Aditya Malhotra</h5>
              </div>
            </div>
            ...
            <div className="lg:col-span-6 space-y-6 pt-8 lg:pt-0">
              ...
              <p className="text-sm sm:text-[15px] text-gray-600 leading-relaxed">
                Ditya Group handles everything that slows down your growth journey. From financial
                guidance to essential services, we simplify your path so you can focus on achieving
                bigger goals. Let us manage what supports your success while you move ahead with
                clarity.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-3">
                ...
                <div className="space-y-3">
                  <div className="w-24 h-24 rounded-full border-4 border-[#FF5722] flex items-center justify-center">
                    <span className="text-xl font-extrabold text-[#011633]">95%</span>
                  </div>
                  <h4 className="text-lg font-bold text-[#011633] leading-snug">
                    Limited Growth Approach
                  </h4>
                  <p className="text-xs text-gray-500 leading-relaxed">
                    Managing everything alone or relying on traditional methods can slow down
                    decisions, reduce efficiency, and limit your true potential.
                  </p>
                </div>
                ...
                <div className="space-y-3">
                  <div className="w-24 h-24 rounded-full border-4 border-[#FF5722] flex items-center justify-center">
                    <span className="text-xl font-extrabold text-[#011633]">100%</span>
                  </div>
                  <h4 className="text-lg font-bold text-[#011633] leading-snug">
                    Ditya Smart System
                  </h4>
                  <p className="text-xs text-gray-500 leading-relaxed">
                    An integrated system of trading guidance, numerology insights, and essential
                    services designed to give you clarity, speed, and complete growth support.
                  </p>
                </div>
              </div>
      ...
      <section className="py-20 bg-[#F9F9F9] border-t border-gray-200/60">
        <div className="max-w-[1140px] mx-auto px-4 text-center">
          ...
          <h2 className="text-2xl sm:text-3xl lg:text-[38px] font-extrabold text-[#011633] mt-2 mb-4">
            How Ditya Group Personalized Approach Works
          </h2>
          <p className="text-sm text-gray-600 max-w-2xl mx-auto mb-14 leading-relaxed">
            Ditya Group provides integrated solutions across finance, numerology, and all other
            essential services. Our personalized approach helps you make better decisions, simplify
            tasks, and grow faster with clarity.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
            ...
            <div className="bg-white rounded-asymmetric p-8 border border-gray-200/70 shadow-sm relative">
              ...
              <h4 className="text-lg font-bold text-[#011633] mb-2">Book a Session</h4>
              <p className="text-xs sm:text-sm text-gray-500 leading-relaxed">
            ...
            <div className="bg-white rounded-asymmetric p-8 border border-gray-200/70 shadow-sm relative">
              ...
              <h4 className="text-lg font-bold text-[#011633] mb-2">Choose Your Service</h4>
              <p className="text-xs sm:text-sm text-gray-500 leading-relaxed">
            ...
            <div className="bg-white rounded-asymmetric p-8 border border-gray-200/70 shadow-sm relative">
              ...
              <h4 className="text-lg font-bold text-[#011633] mb-2">Start Your Journey</h4>
              <p className="text-xs sm:text-sm text-gray-500 leading-relaxed">
          ...
          <div className="bg-[#011633] text-white rounded-asymmetric p-8 sm:p-12 shadow-2xl relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="max-w-2xl space-y-3">
              ...
              <p className="text-xs sm:text-sm text-gray-300 leading-relaxed">
                If you’re unsure about our services, don’t worry! We offer consultations to guide
                you with complete clarity. Our team provides the right support across trading,
                numerology, and essential services to help you make confident decisions.
              </p>
            </div>
            <button
              onClick={() => openModal()}
