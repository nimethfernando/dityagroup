      ...
      <section className="py-20 max-w-[1140px] mx-auto px-4">
        {content.intro && (
          <div className="text-center max-w-2xl mx-auto mb-14 space-y-2">
            <h2 className="text-2xl sm:text-3xl font-extrabold text-[#041614] dark:text-white">
            ...
            return (
              ...
              >
                <div>
                  ...
                  <h3 className="text-xl font-bold text-[#041614] dark:text-white mt-1 mb-3">
                    {item.title}
                  </h3>
                  <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-300 leading-relaxed mb-6 line-clamp-3">
                    {item.desc}
                  </p>

                  <ul className="space-y-2 mb-8">
                    {item.highlights.slice(0, 3).map((h, hIdx) => (
                      <li key={hIdx} className="flex items-center space-x-2 text-xs text-gray-700 dark:text-gray-300">
                        <CheckCircle className="w-3.5 h-3.5 text-[#059669] dark:text-[#10B981] shrink-0" />
                ...
                <div className="pt-4 border-t border-gray-200/60 dark:border-white/10 flex items-center justify-between">
                  <Link
                    href={item.href}
                    className="text-xs font-bold text-[#041614] dark:text-gray-200 hover:text-[#059669] dark:hover:text-[#10B981] inline-flex items-center space-x-1 uppercase tracking-wider"
                  >
