...
export default function AboutUsClient({ content }: AboutUsClientProps) {
  ...
  return (
    <div className="pb-0 bg-white dark:bg-[#030F0E] text-[#041614] dark:text-gray-100 selection:bg-[#059669]/20 selection:text-[#041614] transition-colors duration-200">
      ...
      <section className="py-20 lg:py-24 max-w-[1180px] mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-14 items-start">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            {/* Core Values Card */}
            <div className="bg-white dark:bg-[#061A17] rounded-2xl p-6 sm:p-7 shadow-xl border border-emerald-100/70 dark:border-white/10 bg-gradient-to-br from-white via-[#F0FDF4]/30 to-[#ECFDF5]/50 dark:from-[#061A17] dark:via-[#061A17] dark:to-[#041614] relative overflow-hidden">
              ...
              <div className="flex items-center space-x-2.5 mb-4">
                ...
                <div>
                  <span className="text-[11px] font-bold text-[#059669] dark:text-emerald-400 tracking-widest uppercase block">
                    Our Foundation
                  </span>
                  <h3 className="text-base font-extrabold text-[#041614] dark:text-white">
              ...
              <div className="space-y-3 pt-1">
                {coreValueBullets.map((bullet, idx) => (
                  <div
                    key={idx}
                    className="flex items-start space-x-3 p-2.5 rounded-xl bg-white/80 dark:bg-[#030F0E]/70 border border-gray-100 dark:border-white/10 shadow-sm hover:border-[#059669]/30 transition-colors"
                  >
                    <div className="w-6 h-6 rounded-full bg-[#059669]/10 text-[#059669] dark:bg-emerald-500/20 dark:text-emerald-400 flex items-center justify-center shrink-0 mt-0.5">
                      <CheckCircle2 className="w-4 h-4" />
                    </div>
                    <span className="text-xs sm:text-sm font-semibold text-[#041614] dark:text-white leading-snug">
                      {bullet}
                    </span>
                  </div>
                ))}
          ...
          <div className="lg:col-span-7 space-y-6">
            <div className="space-y-3">
              <span className="text-xs font-bold text-[#059669] dark:text-emerald-400 tracking-wider uppercase flex items-center space-x-2">
                <span className="w-6 h-[2px] bg-[#059669]"></span>
                <span>{coreValues.welcomeBadge || 'Welcome To DITYA GROUP'}</span>
              </span>
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-[#041614] dark:text-white leading-tight tracking-tight">
                {coreValues.heading || 'Our Business Is Making Your Life Easier'}
              </h2>
            </div>

            {/* 3 Full Narrative Paragraphs */}
            <div className="space-y-4 text-sm sm:text-[15px] text-gray-600 dark:text-gray-300 leading-relaxed">
              <p>
                {coreValues.para1 ||
                  'At DITYA Group, we believe growth becomes easier when people have access to the right support systems, structured solutions, and clear guidance. Our mission is to create an ecosystem where individuals, students, professionals, businesses, and organizations can access multiple solutions under one platform.'}
              </p>
              ...
              <p className="font-medium text-[#041614] dark:text-white bg-emerald-50/60 dark:bg-emerald-950/40 p-4 rounded-xl border-l-4 border-[#059669]">
                {coreValues.para3 ||
                  'Whether you are seeking educational support, digital services, financial learning, business solutions, technology support, or structured guidance — DITYA Group is designed to simplify the journey.'}
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
              <div className="p-5 border border-gray-200/80 dark:border-white/10 rounded-2xl bg-gradient-to-br from-[#FAFAFA] to-white dark:from-[#061A17] dark:to-[#041614] hover:border-[#059669]/40 hover:shadow-md transition-all duration-300">
                ...
                <h4 className="font-bold text-sm sm:text-base text-[#041614] dark:text-white">
                  {coreValues.prodCardTitle || 'Increase Productivity'}
                </h4>
                <p className="text-xs sm:text-[13px] text-gray-500 dark:text-gray-300 mt-1.5 leading-relaxed">
      ...
      <section className="py-20 bg-gradient-to-b from-[#F9FAFB] via-[#F3F4F6]/60 to-[#F9FAFB] dark:from-[#030F0E] dark:via-[#061A17] dark:to-[#030F0E] border-t border-b border-gray-200/70 dark:border-white/10 relative overflow-hidden transition-colors duration-200">
        ...
        <div className="max-w-[860px] mx-auto px-4 text-center space-y-6 relative z-10">
          <div className="inline-flex items-center space-x-2 bg-[#059669]/10 dark:bg-emerald-500/20 border border-[#059669]/20 dark:border-emerald-500/30 px-3.5 py-1 rounded-full text-xs font-bold text-[#059669] dark:text-emerald-400 uppercase tracking-wider">
          ...
          <div className="relative">
            <Quote className="w-12 h-12 text-[#059669]/15 dark:text-emerald-400/20 mx-auto -mb-6" />
            <blockquote className="text-xl sm:text-2xl font-semibold text-[#041614] dark:text-white italic leading-relaxed px-4 sm:px-8">
              {founder.quote ||
                '“Our vision is simple — create systems, services, and solutions that make growth easier for individuals and businesses while continuously expanding opportunities under one ecosystem.”'}
            </blockquote>
          </div>
          ...
          <div className="pt-2">
            <h4 className="text-lg sm:text-xl font-extrabold text-[#041614] dark:text-white tracking-tight">
              {founder.name || 'Aamitt Batra'}
            </h4>
            <p className="text-xs sm:text-sm font-medium text-[#059669] dark:text-emerald-400 mt-0.5">
      ...
      <section className="py-16 bg-white dark:bg-[#030F0E] border-b border-gray-100 dark:border-white/10 transition-colors duration-200">
        <div className="max-w-[1140px] mx-auto px-4">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            {/* Stat 1 */}
            <div className="bg-gradient-to-br from-[#F9FAFB] to-white dark:from-[#061A17] dark:to-[#041614] p-6 sm:p-7 rounded-2xl border border-gray-200/70 dark:border-white/10 shadow-sm text-center hover:border-[#059669]/40 hover:shadow-md transition-all duration-300 group">
              <div className="w-12 h-12 rounded-xl bg-[#059669]/10 dark:bg-emerald-500/20 text-[#059669] dark:text-emerald-400 flex items-center justify-center mx-auto mb-3.5 group-hover:scale-110 transition-transform">
                <Users className="w-6 h-6" />
              </div>
              <div className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-[#041614] dark:text-white tracking-tight">
                <AnimatedCounter value={stats.stat1Number || '500 +'} />
              </div>
              <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-300 font-semibold mt-1">
      ...
      <section className="py-20 lg:py-24 bg-[#FAFAFA] dark:bg-[#030F0E] relative overflow-hidden transition-colors duration-200">
        <div className="max-w-[1140px] mx-auto px-4">
          <div className="text-center max-w-2xl mx-auto mb-16 space-y-3">
            <span className="text-xs font-bold text-[#059669] dark:text-emerald-400 tracking-wider uppercase inline-block bg-[#059669]/10 dark:bg-emerald-500/20 px-3.5 py-1 rounded-full border border-[#059669]/20 dark:border-emerald-500/30">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative mb-16">
            {/* Step 1 */}
            <div className="bg-white dark:bg-[#061A17] rounded-2xl p-7 border border-gray-200/80 dark:border-white/10 shadow-sm relative group hover:border-[#059669]/50 hover:shadow-xl transition-all duration-300">
              <div className="text-4xl font-black text-[#059669]/20 dark:text-emerald-500/30 group-hover:text-[#059669] dark:group-hover:text-emerald-400 transition-colors mb-4">
                {howItWorks.step1Num || '01'}
              </div>
              <h3 className="font-bold text-base text-[#041614] dark:text-white mb-2">
      ...
      <section className="py-20 lg:py-24 bg-white dark:bg-[#030F0E] transition-colors duration-200">
        <div className="max-w-[1140px] mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="p-7 rounded-2xl border border-gray-200 dark:border-white/10 bg-[#F9FAFB] dark:bg-[#061A17] flex flex-col sm:flex-row items-center sm:items-start space-y-4 sm:space-y-0 sm:space-x-6 text-center sm:text-left">
              ...
              <div className="space-y-2">
                ...
                <h3 className="text-base sm:text-lg font-bold text-[#041614] dark:text-white">
            ...
            <div className="p-7 rounded-2xl border-2 border-[#059669]/30 dark:border-emerald-500/30 bg-gradient-to-br from-white to-[#ECFDF5]/30 dark:from-[#061A17] dark:to-[#041614] shadow-lg flex flex-col sm:flex-row items-center sm:items-start space-y-4 sm:space-y-0 sm:space-x-6 text-center sm:text-left relative overflow-hidden">
              ...
              <div className="space-y-2">
                ...
                <h3 className="text-base sm:text-lg font-extrabold text-[#041614] dark:text-white">
