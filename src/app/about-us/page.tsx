...
import { Check, TrendingUp, Clock, Award, Users, FileCheck } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-6 relative">
            ...
            <div className="absolute -bottom-6 left-6 right-6 bg-[#FF5722] text-white p-6 rounded-asymmetric shadow-xl">
              ...
              <p className="text-sm font-semibold mt-1">
                Creating an integrated ecosystem where individuals and enterprises grow with clarity
                and confidence.
              </p>
            </div>
          </div>
          ...
          <div className="lg:col-span-6 space-y-6 pt-6 lg:pt-0">
            ...
            <p className="text-sm sm:text-[15px] text-gray-600 leading-relaxed">
              At DITYA Group, we believe growth becomes easier when people have access to the right
              support systems, structured solutions, and clear guidance. Our mission is to create an
              ecosystem where individuals, students, professionals, businesses, and organizations can
              access multiple solutions under one platform.
            </p>

            <p className="text-sm sm:text-[15px] text-gray-600 leading-relaxed">
              DITYA Group was built with the vision of creating practical solutions that support
              learning, technology, business growth, digital transformation, financial
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
              <div className="p-4 border border-gray-200 rounded-asymmetric bg-[#F9F9F9]">
                ...
                <h4 className="font-bold text-sm text-[#011633]">Increase Productivity</h4>
              ...
              <div className="p-4 border border-gray-200 rounded-asymmetric bg-[#F9F9F9]">
                ...
                <h4 className="font-bold text-sm text-[#011633]">Save Valuable Time</h4>
                <p className="text-xs text-gray-500 mt-1">
      ...
      <section className="py-16 bg-[#F9F9F9] border-t border-b border-gray-200/60">
        <div className="max-w-[800px] mx-auto px-4 text-center space-y-6">
          ...
          <blockquote className="text-lg sm:text-xl font-medium text-[#011633] italic leading-relaxed">
            “Our vision is simple — create systems, services, and solutions that make growth easier
            for individuals and businesses while continuously expanding opportunities under one
            ecosystem.”
          </blockquote>
          <div>
            <h4 className="text-lg font-bold text-[#011633]">Aamitt Batra</h4>
            <p className="text-xs text-gray-500">Founder & CEO, DITYA GROUP</p>
          </div>
